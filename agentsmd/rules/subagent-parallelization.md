...
| 4+ | Mark as failed, move on |

After 3 failures on the same item, mark as "needs human review" and continue with remaining items. Don't let one failure block everything.
