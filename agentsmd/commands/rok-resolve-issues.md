...
- **Priority matrix**: P0 -> P1 -> P2 -> bug -> enhancement -> documentation
...
> 1. Implement foundational changes
> 1. Add synergistic enhancements
> 1. Apply coordinated tooling updates
> 1. Implement enhanced features
> 1. Update comprehensive documentation
> 1. Create PR linking all related work
...
**Think step by step and use thinking mode extensively.** Analyze the current repository state,
identify high-priority issues and their relationships, create an efficient implementation plan,
