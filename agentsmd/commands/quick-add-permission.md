...
model: haiku
allowed-tools: Bash(git fetch:*), Bash(git pull:*), Bash(git switch:*), Bash(git checkout:*), Bash(git status:*), Bash(git worktree add:*), Bash(git worktree list:*), Bash(git branch:*), AskUserQuestion
---
