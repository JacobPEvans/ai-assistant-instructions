...
model: sonnet
author: JacobPEvans
allowed-tools: Task, TaskOutput, Read, Write, Edit, Grep, Glob, TodoWrite, Bash(terraform *), Bash(ansible *), Bash(ansible-playbook *), Bash(ansible-lint *), Bash(doppler *), Bash(git *), Bash(gh *), Bash(cd *), Bash(ls *), Bash(pwd *)
---
