...
author: JacobPEvans
allowed-tools: Task, TaskOutput, Bash(npm:*), Bash(yarn:*), Bash(pnpm:*), Bash(pytest:*), Bash(jest:*), Bash(vitest:*), Bash(cargo test:*), Bash(go test:*), Bash(mvn test:*), Bash(gradle test:*), Bash(cd:*), Bash(pwd:*)
---
