...
author: JacobPEvans
allowed-tools: Task, TaskOutput, TodoWrite, Bash(npm:*), Bash(yarn:*), Bash(pnpm:*), Bash(pip:*), Bash(cargo:*),
  Bash(go get:*), Bash(go mod:*), Bash(bundle:*), Bash(cd:*), Bash(pwd:*), Read, Grep, Glob, Edit
---
