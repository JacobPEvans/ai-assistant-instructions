...
author: JacobPEvans
allowed-tools: >
  Task, TaskOutput, Bash(npm:*), Bash(yarn:*), Bash(pnpm:*), Bash(eslint:*),
  Bash(markdownlint:*), Bash(ruff:*), Bash(black:*), Bash(flake8:*),
  Bash(clippy:*), Bash(cargo fmt:*), Bash(gofmt:*), Bash(golangci-lint:*),
  Bash(cd:*), Bash(pwd:*)
---
